...
const int ENCLOSURE_ID =        1001;
const int ARDUINO_ID =          1002;
const int DATASHIELD_ID =       1003;
const int SDCARD_ID =           1008;
const int SHINYEI_ID =          1006;
const int O3_SENSOR_ID =        1004;
const int CO_SENSOR_ID =        1005;
const int DHT22_ID =            1007;
const int BATTERY_ID =          1009;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0119*x)+6.862;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
