...
const int SENSOR_ID =           32;
const int ENCLOSURE_ID =        3201;
const int ARDUINO_ID =          3202;
const int DATASHIELD_ID =       3203;
const int SDCARD_ID =           3208;
const int SHINYEI_ID =          3206;
const int O3_SENSOR_ID =        3204;
const int CO_SENSOR_ID =        3205;
const int DHT22_ID =            3207;
const int BATTERY_ID =          3209;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0126*x)+11.343;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
