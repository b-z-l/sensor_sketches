...
const int ENCLOSURE_ID =        301;
const int ARDUINO_ID =          302;
const int DATASHIELD_ID =       303;
const int SDCARD_ID =           308;
const int SHINYEI_ID =          306;
const int O3_SENSOR_ID =        304;
const int CO_SENSOR_ID =        305;
const int DHT22_ID =            307;
const int BATTERY_ID =          309;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0093*x)+30.995;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
