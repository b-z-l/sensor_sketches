...
const int SENSOR_ID =           33;
const int ENCLOSURE_ID =        3301;
const int ARDUINO_ID =          3302;
const int DATASHIELD_ID =       3303;
const int SDCARD_ID =           3308;
const int SHINYEI_ID =          3306;
const int O3_SENSOR_ID =        3304;
const int CO_SENSOR_ID =        3305;
const int DHT22_ID =            3307;
const int BATTERY_ID =          3309;
