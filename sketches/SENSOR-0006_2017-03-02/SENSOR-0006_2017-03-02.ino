...
const int SENSOR_ID =           6;
const int ENCLOSURE_ID =        601;
const int ARDUINO_ID =          602;
const int DATASHIELD_ID =       603;
const int SDCARD_ID =           608;
const int SHINYEI_ID =          606;
const int O3_SENSOR_ID =        604;
const int CO_SENSOR_ID =        605;
const int DHT22_ID =            607;
const int BATTERY_ID =          609;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0112*x)+10.689;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
