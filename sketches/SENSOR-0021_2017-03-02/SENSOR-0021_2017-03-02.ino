...
const int SENSOR_ID =           21;
const int ENCLOSURE_ID =        2101;
const int ARDUINO_ID =          2102;
const int DATASHIELD_ID =       2103;
const int SDCARD_ID =           2108;
const int SHINYEI_ID =          2106;
const int O3_SENSOR_ID =        2104;
const int CO_SENSOR_ID =        2105;
const int DHT22_ID =            2107;
const int BATTERY_ID =          2109;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0162*x)+9.0079;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
