...
const int ENCLOSURE_ID =        501;
const int ARDUINO_ID =          502;
const int DATASHIELD_ID =       503;
const int SDCARD_ID =           508;
const int SHINYEI_ID =          506;
const int O3_SENSOR_ID =        504;
const int CO_SENSOR_ID =        505;
const int DHT22_ID =            507;
const int BATTERY_ID =          509;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.012*x)+15.543;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
