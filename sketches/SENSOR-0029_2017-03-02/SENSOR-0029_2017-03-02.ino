...
const int SENSOR_ID =           29;
const int ENCLOSURE_ID =        2901;
const int ARDUINO_ID =          2902;
const int DATASHIELD_ID =       2903;
const int SDCARD_ID =           2908;
const int SHINYEI_ID =          2906;
const int O3_SENSOR_ID =        2904;
const int CO_SENSOR_ID =        2905;
const int DHT22_ID =            2907;
const int BATTERY_ID =          2909;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0117*x)+12.99;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
