...
const int ENCLOSURE_ID =        201;
const int ARDUINO_ID =          202;
const int DATASHIELD_ID =       203;
const int SDCARD_ID =           208;
const int SHINYEI_ID =          206;
const int O3_SENSOR_ID =        204;
const int CO_SENSOR_ID =        205;
const int DHT22_ID =            207;
const int BATTERY_ID =          209;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0113*x)+7.7414;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
