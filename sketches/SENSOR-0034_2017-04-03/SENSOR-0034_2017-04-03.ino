...
const int SENSOR_ID =           34;
const int ENCLOSURE_ID =        3401;
const int ARDUINO_ID =          3402;
const int DATASHIELD_ID =       3403;
const int SDCARD_ID =           3408;
const int SHINYEI_ID =          3406;
const int O3_SENSOR_ID =        3404;
const int CO_SENSOR_ID =        3405;
const int DHT22_ID =            3407;
const int BATTERY_ID =          3409;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0108*x)+6.6121;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
