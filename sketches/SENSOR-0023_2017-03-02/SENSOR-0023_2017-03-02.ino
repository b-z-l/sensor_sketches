...
const int ENCLOSURE_ID =        2301;
const int ARDUINO_ID =          2302;
const int DATASHIELD_ID =       2303;
const int SDCARD_ID =           2308;
const int SHINYEI_ID =          2306;
const int O3_SENSOR_ID =        2304;
const int CO_SENSOR_ID =        2305;
const int DHT22_ID =            2307;
const int BATTERY_ID =          2309;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0105*x)+9.3107;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
