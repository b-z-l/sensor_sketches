...
const int ENCLOSURE_ID =        1401;
const int ARDUINO_ID =          1402;
const int DATASHIELD_ID =       1403;
const int SDCARD_ID =           1408;
const int SHINYEI_ID =          1406;
const int O3_SENSOR_ID =        1404;
const int CO_SENSOR_ID =        1405;
const int DHT22_ID =            1407;
const int BATTERY_ID =          1409;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0114*x)+7.318;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
