...
const int ENCLOSURE_ID =        1301;
const int ARDUINO_ID =          1302;
const int DATASHIELD_ID =       1303;
const int SDCARD_ID =           1308;
const int SHINYEI_ID =          1306;
const int O3_SENSOR_ID =        1304;
const int CO_SENSOR_ID =        1305;
const int DHT22_ID =            1307;
const int BATTERY_ID =          1309;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0159*x)+34.712;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
