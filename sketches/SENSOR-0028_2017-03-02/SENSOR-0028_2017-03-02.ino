...
const int SENSOR_ID =           28;
const int ENCLOSURE_ID =        2801;
const int ARDUINO_ID =          2802;
const int DATASHIELD_ID =       2803;
const int SDCARD_ID =           2808;
const int SHINYEI_ID =          2806;
const int O3_SENSOR_ID =        2804;
const int CO_SENSOR_ID =        2805;
const int DHT22_ID =            2807;
const int BATTERY_ID =          2809;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0156*x)+14.704;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
