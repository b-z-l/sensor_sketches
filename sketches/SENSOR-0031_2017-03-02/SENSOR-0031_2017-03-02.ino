...
const int SENSOR_ID =           31;
const int ENCLOSURE_ID =        3101;
const int ARDUINO_ID =          3102;
const int DATASHIELD_ID =       3103;
const int SDCARD_ID =           3108;
const int SHINYEI_ID =          3106;
const int O3_SENSOR_ID =        3104;
const int CO_SENSOR_ID =        3105;
const int DHT22_ID =            3107;
const int BATTERY_ID =          3109;
