...
const int SENSOR_ID =           26;
const int ENCLOSURE_ID =        2601;
const int ARDUINO_ID =          2602;
const int DATASHIELD_ID =       2603;
const int SDCARD_ID =           2608;
const int SHINYEI_ID =          2606;
const int O3_SENSOR_ID =        2604;
const int CO_SENSOR_ID =        2605;
const int DHT22_ID =            2607;
const int BATTERY_ID =          2609;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0163*x)+11.127;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
