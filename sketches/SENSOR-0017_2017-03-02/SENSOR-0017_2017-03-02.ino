...
const int SENSOR_ID =           17;
const int ENCLOSURE_ID =        1701;
const int ARDUINO_ID =          1702;
const int DATASHIELD_ID =       1703;
const int SDCARD_ID =           1708;
const int SHINYEI_ID =          1706;
const int O3_SENSOR_ID =        1704;
const int CO_SENSOR_ID =        1705;
const int DHT22_ID =            1707;
const int BATTERY_ID =          1709;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0108*x)+0.5007;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
