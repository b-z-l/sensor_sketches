...
const int SENSOR_ID =           25;
const int ENCLOSURE_ID =        2501;
const int ARDUINO_ID =          2502;
const int DATASHIELD_ID =       2503;
const int SDCARD_ID =           2508;
const int SHINYEI_ID =          2506;
const int O3_SENSOR_ID =        2504;
const int CO_SENSOR_ID =        2505;
const int DHT22_ID =            2507;
const int BATTERY_ID =          2509;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0134*x)+13.356;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
