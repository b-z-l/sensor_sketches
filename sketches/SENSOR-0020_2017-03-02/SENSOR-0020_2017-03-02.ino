...
const int SENSOR_ID =           20;
const int ENCLOSURE_ID =        2001;
const int ARDUINO_ID =          2002;
const int DATASHIELD_ID =       2003;
const int SDCARD_ID =           2008;
const int SHINYEI_ID =          2006;
const int O3_SENSOR_ID =        2004;
const int CO_SENSOR_ID =        2005;
const int DHT22_ID =            2007;
const int BATTERY_ID =          2009;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0128*x)+8.4302;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
