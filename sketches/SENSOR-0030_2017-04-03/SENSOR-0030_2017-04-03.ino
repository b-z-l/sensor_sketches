...
const int SENSOR_ID =           30;
const int ENCLOSURE_ID =        3001;
const int ARDUINO_ID =          3002;
const int DATASHIELD_ID =       3003;
const int SDCARD_ID =           3008;
const int SHINYEI_ID =          3006;
const int O3_SENSOR_ID =        3004;
const int CO_SENSOR_ID =        3005;
const int DHT22_ID =            3007;
const int BATTERY_ID =          3009;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0108*x)+2.8819;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
