...
const int ENCLOSURE_ID =        401;
const int ARDUINO_ID =          402;
const int DATASHIELD_ID =       403;
const int SDCARD_ID =           408;
const int SHINYEI_ID =          406;
const int O3_SENSOR_ID =        404;
const int CO_SENSOR_ID =        405;
const int DHT22_ID =            407;
const int BATTERY_ID =          409;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0073*x)+31.9;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
