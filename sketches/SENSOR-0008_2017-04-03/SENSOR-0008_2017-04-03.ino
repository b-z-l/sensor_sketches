...
const int ENCLOSURE_ID =        801;
const int ARDUINO_ID =          802;
const int DATASHIELD_ID =       803;
const int SDCARD_ID =           808;
const int SHINYEI_ID =          806;
const int O3_SENSOR_ID =        804;
const int CO_SENSOR_ID =        805;
const int DHT22_ID =            807;
const int BATTERY_ID =          809;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0136*x)+16.426;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
