...
const int SENSOR_ID =           36;
const int ENCLOSURE_ID =        3601;
const int ARDUINO_ID =          3602;
const int DATASHIELD_ID =       3603;
const int SDCARD_ID =           3608;
const int SHINYEI_ID =          3606;
const int O3_SENSOR_ID =        3604;
const int CO_SENSOR_ID =        3605;
const int DHT22_ID =            3607;
const int BATTERY_ID =          3609;
...
void calculatePM() {
  ...
  if ((millis() - starttime) > sampletime_ms) {
    ...
    float x = PM25count;
    PM25conc = (0.0136*x)+9.6994;                 // Shinyie_4 Equation (power function)
    lowpulseoccupancy = 0;
    starttime = millis();
  }
}
